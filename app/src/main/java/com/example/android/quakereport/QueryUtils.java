...
public final class QueryUtils {
    ...
    public static List<EarthQuake> extractFeatureFromJson(String jsonResponse) {
        ...
        try {
            ...
            {
                JSONObject curquake=feature.getJSONObject(i);
                JSONObject prop=curquake.getJSONObject("properties");
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            if(urlConnection.getResponseCode()==200)
            {
                ...
                Log.e(LOG_TAG,"Error Resonse code "+urlConnection.getResponseMessage());
            }
        } catch (IOException e) {
            Log.e(LOG_TAG,"Problem retreiving the Json Result");
        }finally {
    ...
    private static String readFomStream(InputStream inputStream) throws IOException {
